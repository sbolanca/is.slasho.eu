    ...
    */
     ...
     */
     function EncodeQP ($str) {
		...
		$encoded = preg_replace_callback('/([\000-\010\013\014\016-\037\075\177-\377])/',function($m) { return '='.sprintf('%02X', ord($m[1])); }, $encoded);
           
        // Replace every spaces and tabs when it's the last character on a line
       // $encoded = preg_replace("/([\011\040])".$this->LE."/e",
        //          "'='.sprintf('%02X', ord('\\1')).'".$this->LE."'", $encoded);
		$LE=$this->LE;
		$encoded = preg_replace_callback("/([\011\040])".$this->LE."/",function($m) use($LE) { return '='.sprintf('%02X', ord($m[1]).$LE); }, $encoded);
