...
function dhtmlXGridObject(a) {
        ...
        for (var a = 0, b = [], c = 0, d = 0; d < this._cCount; d++)
            if (this.initCellWidth[d] == "*" && !this._hrrar[d]) this._awdth = !1, b.push(d);
                ...
                if (this.cellWidthType == "%") {
                    typeof this.cellWidthPC[d] == "undefined" && (this.cellWidthPC[d] =
                        this.initCellWidth[d]);
        ...
        if (this.hdr.rows[0]) {
            ...
            if (!this.dontSetSizes)
                if (this.globalBox) {
                    ...
                    if (this._delta_x && !this._realfake) {
                        ...
                        this.entBox.style.width =
                            Math.max(0, this.globalBox.clientWidth + (e ? b * 2 : 0) - this._fake.entBox.clientWidth) + "px";
                    ...
                    if (this._delta_x) this.entBox.parentNode && this.entBox.parentNode.tagName == "TD" ? (this.entBox.style.width =
                        "1px", this.entBox.style.width = parseInt(this._delta_x) * this.entBox.parentNode.clientWidth / 100 - a * 2 + "px") : this.entBox.style.width = this._delta_x;
            ...
            if (!this.entBox.offsetWidth && (!this.globalBox || !this.globalBox.offsetWidth)) this._sizeTime = window.setTimeout(function() {
                ...
                var d = !this._wthB && (this.entBox.cmp || this._delta_x) && (this.skin_name || "").indexOf("dhx") == 0 && !e ? 2 : 0,
                    h = !this._wthB &&
                    (this.entBox.cmp || this._delta_y) && (this.skin_name || "").indexOf("dhx") == 0 && !e ? 2 : 0;
                ...
                var l = this.parentGrid ? !1 : this.objBox.scrollHeight > this.objBox.offsetHeight,
                    ...
                    r = this.parentGrid ? !1 : this.objBox.scrollWidth > this.objBox.offsetWidth ||
                    this.objBox.style.overflowX == "scroll",
                    q = this.hdr.clientHeight,
                    s = this.ftr ? this.ftr.clientHeight : 0,
                    u = m,
                    t = o - q - s;
                this._awdth && this._awdth[0] && this._awdth[1] == 99999 && (r = 0);
                if (this._ahgr && (t = this._ahgrMA ? this.entBox.parentNode.clientHeight - q - s : this.obj.offsetHeight + (r ? k : 0) + (this._correction_y || 0), this._ahgrM && (t = this._ahgrF ? Math.min(this._ahgrM, t + q + s) - q - s : Math.min(this._ahgrM, t)), l && t >= this.obj.scrollHeight + (r ? k : 0))) l = !1, this.setColumnSizes(n - (this._correction_x || 0));
                ...
                if (!this.dontSetSizes) this.entBox.style.width = Math.max(0, u + (e ? 2 : 0) * a + this._ff_size_delta) + "px", this.entBox.style.height = t + (e ? 2 : 0) * a + q + s + "px";
                this.objBox.style.height = t + (e && !l ? 2 : 0) * a + "px";
                this.hdrBox.style.height =
                    q + "px";
                t != o && this.doOnScroll(0, !this._srnd);
                var v = this["setSizes_" + this.skin_name];
                v && v.call(this);
                this.setSortImgPos();
                q != this.hdr.clientHeight && this._ahgr && this.setSizes();
    ...
    this.chngCellWidth = function() {
        if (_isOpera && this.ftr) this.ftr.width =
    ...
    this.setInitWidths = function(e) {
        ...
        if (_isFF)
            for (var a = 0; a < this.initCellWidth.length; a++) this.initCellWidth[a] != "*" && (this.initCellWidth[a] = parseInt(this.initCellWidth[a]))
    };
    this.enableMultiline = function(e) {
        this.multiLine =
            convertStringToBoolean(e)
    };
    this.enableMultiselect = function(e) {
        this.selMultiRows = convertStringToBoolean(e)
    };
    this.setImagesPath = this.setImagePath = function(e) {
        this.imgURL = e
    };
    this.setIconsPath = this.setIconPath = function(e) {
        this.iconURL = e
    };
    this.changeCursorState = function(e) {
        var a = e.target || e.srcElement;
        a.tagName != "TD" && (a = this.getFirstParentOfType(a, "TD"));
        if (a) {
            if (a.tagName == "TD" && this._drsclmn && !this._drsclmn[a._cellIndex]) return a.style.cursor = "default";
            var b = (e.layerX || 0) + (!_isIE && e.target.tagName ==
                "DIV" ? a.offsetLeft : 0);
            a.style.cursor = a.offsetWidth - (e.offsetX || (parseInt(this.getPosition(a, this.hdrBox)) - b) * -1) < (_isOpera ? 20 : 10) ? "E-resize" : "default";
    ...
    this.startColResize = function(a) {
        ...
        if (b.tagName == "TD" && b.style.cursor != "default" && (!this._drsclmn ||
            this._drsclmn[b._cellIndex])) c._old_d_mm = document.body.onmousemove, c._old_d_mu = document.body.onmouseup, document.body.onmousemove = function(a) {
    ...
    this.setSortImgState = function(a, b, c, f) {
        ...
        } else this.sortImg.style.display = "none",
            ...
            if (!r && !a.parentNode._sRow)
                if (this.callEvent("onBeforeSelect", [a.parentNode.idd, g]))
                    if (this.getSelectedRowId() != a.parentNode.idd) {
                        if (d == 0 && this.clearSelection(), this.cell = a, l == a.parentNode && this._chRRS && (b = !1), this.row = a.parentNode, this.row.className += " rowselected", this.selectedRows._dhx_find(this.row) == -1) this.selectedRows[this.selectedRows.length] = this.row
                    } else this.cell = a, this.row = a.parentNode;
            else b = !1; if (this.cell && this.cell.parentNode.className.indexOf("rowselected") != -1) this.cell.className = this.cell.className.replace(/cellselected/g, "") + " cellselected";
            if (d != 1 && !this.row) return;
            this.lastClicked = a.parentNode;
            var q = this.row.idd,
                s = this.cell;
            b && typeof q != "undefined" && s && !r ? c.onRowSelectTime = setTimeout(function() {
                c.callEvent && c.callEvent("onRowSelect", [q, s._cellIndex])
            }, 100) : this.callEvent("onRowSelectRSOnly", [q]);
            if (this.checkEvent("onSelectStateChanged")) {
                var u = this.getSelectedId();
                h != u && this.callEvent("onSelectStateChanged", [u, h])
            }
        }
        this.isActive = !0;
    ...
    this.selectCell = function(a, b, c, d, g, h) {
        ...
        l || (l = a.childNodes[0]);
        this.markedCells ? this.doMark(l,
            d ? 2 : 0) : d ? this.doClick(l, c, 3, h) : this.doClick(l, c, 0, h);
        g && this.editCell()
    };
        ...
        try {
            if (a.offsetHeight) {
                var d = a.offsetLeft + a.offsetWidth + 20,
                    g = 0;
                d > this.objBox.offsetWidth + this.objBox.scrollLeft ? a.offsetLeft > this.objBox.scrollLeft && (g = a.offsetLeft - 5) : a.offsetLeft < this.objBox.scrollLeft && (d -= a.offsetWidth * 2 / 3, d < this.objBox.scrollLeft && (g = a.offsetLeft -
                    5));
            ...
            else d < this.objBox.scrollTop && (k = d - 5); if (k) this.objBox.scrollTop = k
        } catch (m) {}
    };
    ...
    this.editStop = function(a) {
        ...
        if (this.editor && this.editor != null)
            if (this.editor.cell.className = this.editor.cell.className.replace("editable", ""), a) {
                ...
                if (typeof d == "string" || typeof d ==
                    "number") c[c.setImage ? "setLabel" : "setValue"](d);
    ...
    this._getNextCell = function(a, b, c) {
        var a = a || this.cell,
            d = a.parentNode;
        this._tabOrder ? (c = this._tabOrder[a._cellIndex], typeof c != "undefined" && (a = c < 0 ? this._nextRowCell(d, b, Math.abs(c) -
            1) : d.childNodes[c])) : (c = a._cellIndex + b, c >= 0 && c < this._cCount ? (d._childIndexes && (c = d._childIndexes[a._cellIndex] + b), a = d.childNodes[c]) : a = this._nextRowCell(d, b, b == 1 ? 0 : this._cCount - 1));
    ...
    this.scrollPage = function(a) {
        if (this.rowsBuffer.length) {
            ...
            if (this._srnd && !this.rowsBuffer[c]) {
                this.objBox.scrollTop += Math.floor(a * this.objBox.offsetHeight / (this._srdh || 20)) * (this._srdh ||
                    20);
	...
	this.scrollToIndex = function(a) {
						//var new_ind=ix;
                        //if (new_ind<0) new_ind=0;
                        //if (new_ind>=this.getRowsNum()) new_ind=this.getRowsNum()-1;
        if (this.rowsBuffer.length) {
            var b = this._realfake ? this._fake : this,
                c = a;
            c < 0 && (c = 0);
            ...
            if (this._srnd && !this.rowsBuffer[c]) {
               ...
               this.objBox.scrollTop = Math.floor(c *  (this._srdh || 20));
                if (this._fake) this._fake.objBox.scrollTop = this.objBox.scrollTop;
                b._r_select = c
            } else {
                this.selectCell(c, this.cell._cellIndex, !0, !1, !1, this.multiLine || this._srnd);
    ...
    this.doKey = function(a) {
        ...
        if ((a.target || a.srcElement).value !== window.undefined) {
            var b = a.target || a.srcElement;
            if (!b.parentNode ||
                b.parentNode.className.indexOf("editable") == -1) return !0
        }
        ...
        if (this.cell) {
            ...
            this._key_events.k_other &&
                this._key_events.k_other.call(this, a)
        }
        return !0
    };
    ...
    this.changeRowId = function(a, b) {
        if (a != b) {
            ...
            if (this._h2 && this._h2.get[a]) this._h2.get[b] = this._h2.get[a],
                this._h2.get[b].id = b, delete this._h2.get[a];
            this.rowsAr[a] = null;
            this.rowsAr[b] = c;
    ...
    this.getColLabel = this.getColumnLabel = function(a, b, c) {
        for (var d = (c || this.hdr).rows[(b || 0) + 1], g = 0; g < d.cells.length; g++)
    ...
    this.setRowTextStyle = function(a, b) {
        ...
        if (c)
            for (var d = 0; d < c.childNodes.length; d++) {
                ...
                c.childNodes[d].style.cssText = g + "width:" + c.childNodes[d].style.width + ";" + b
            }
    };
    ...
    this.setCellTextStyle = function(a, b, c) {
        ...
        if (d) {
            var g =
                d.childNodes[d._childIndexes ? d._childIndexes[b] : b];
            if (g) {
                var h = "";
    ...
    this.clearAll = function(a) {
        if (this.obj.rows[0]) {
            if (this._h2 &&
                (this._h2 = new dhtmlxHierarchy, this._fake)) this._realfake ? this._h2 = this._fake._h2 : this._fake._h2 = this._h2;
            ...
            if (a) {
                ...
                for (c = this.hdr.rows.length -
                    1; c >= 0; c--) d = this.hdr.rows[c], d.parentNode.removeChild(d);
    ...
    this.setHeader = function(a, b, c) {
        ...
        this.hdrLabels = d;
        this.cellWidth = g;
        this.initCellWidth.length ||
            this.setInitWidthsP(g.join(this.delim), !0);
        this.cellType = h;
        this.cellAlign = l;
        this.cellVAlign = k;
        this.fldSort = m;
    ...
    if (!_isOpera || _OperaRv > 8.5) this.hdr.onmousemove = function(a) {
        ...
        return this.grid.startColResize(a ||
            window.event)
    };
    ...
    _isMacOS ? this.entBox.oncontextmenu = function(a) {
        ...
        return this.grid._doContClick(a ||
            window.event)
    ...
    if (this.entBox.style.width.toString().indexOf("%") !=
        -1) this._delta_x = this.entBox.style.width;
...
dhtmlXGridObject.prototype = {
    ...
    _parseHead: function(a) {
        ...
        if (b.length) {
            var c = this.xmlLoader.doXPath("./column",
                ...
                j = !1;
            if (d[0])
                for (var i = 0; i < d[0].childNodes.length; i++) switch (d[0].childNodes[i].tagName) {
                    case "colwidth":
            ...
            if (c.length > 0) {
                ...
                for (l = 0; l < c.length; l++)
                    if (this.cellType[l].indexOf("co") == 0 || this.cellType[l] ==
                        "clist") {
        ...
        if (r.length > 0) {
            ...
            for (k = 0; k < r.length; k++) {
                for (var q = "", s = 0; s < r[k].childNodes.length; s++) q += r[k].childNodes[s].nodeValue;
        ...
        if (!this._hrrar || !this._hrrar[a]) {
            ...
            for (var d = 1; d < this.hdr.rows.length; d++) {
                ...
                if ((e = e.childNodes[e._childIndexes ? e._childIndexes[a] :
                    a]) && (!e.colSpan || e.colSpan < 2) && e._cellIndex == a) e.childNodes[0] && e.childNodes[0].className == "hdrcell" && (e = e.childNodes[0]), c = Math.max(c, e.scrollWidth)
            }
            for (var j = this.obj.rows.length, i = 1; i < j; i++) {
                var f = this.obj.rows[i];
    ...
    _createHRow: function(a,
        ...
        if (!b) {
            ...
            this.ftr = b = d;
            for (var e = d.insertRow(0), j = this.hdrLabels.length <= 1 ? a[0].length : this.hdrLabels.length,
                i = 0; i < j; i++) e.appendChild(document.createElement("TH")), e.childNodes[i]._cellIndex = i;
    ...
    _refreshFromXML: function(a) {
        ...
        reset = !1;
        if (window.eXcell_tree) eXcell_tree.prototype.setValueX =
            eXcell_tree.prototype.setValue, eXcell_tree.prototype.setValue = function(a) {
        ...
        for (var e = a.doXPath("//row"), j = 0; j < e.length; j++) {
            ...
            if (this.rowsAr[f] && this.rowsAr[f].tagName != "TR") this._h2 ? this._h2.get[f].buff.data = i : this.rowsBuffer[this.getRowIndex(f)].data = i, this.rowsAr[f] = i;
                ...
                if (this._h2) reset = !0, this._h2.add(f, i.parentNode.getAttribute("id") || i.parentNode.getAttribute("parent")).buff = this.rowsBuffer[this.rowsBuffer.length - 1];
                this.rowsAr[f] = i;
                i = this.render_row(h);
    ...
    _postRowProcessing: function(a, b) {
        ...
        for (var c = 0, d = 0; d < a.childNodes.length; d++) {
            ...
            if (i =
                e._attrs.align || this.cellAlign[j]) e.align = i;
            e.vAlign = e._attrs.valign || this.cellVAlign[j];
            var f = e._attrs.bgColor || this.columnColor[j];
            if (f) e.bgColor = f;
    ...
    _process_json: function(a, b) {
        ...
        if (b == "js") {
            ...
            }), this.rowsAr[e] = a.rows[c]; if (a.dhx_security) dhtmlx.security_key = a.dhx_security;
        this.render_dataset();
        this._parsing = !1
    },
    ...
    _sortCore: function(a, b, c, d, e) {
        ...
        if (b == "str") e[j](function(a, b) {
            return c == "asc" ?
                d[a.idd] > d[b.idd] ? 1 : d[a.idd] < d[b.idd] ? -1 : 0 : d[a.idd] < d[b.idd] ? 1 : d[a.idd] > d[b.idd] ? -1 : 0
        });
        else if (b == "int") e[j](function(a, b) {
            var e = parseFloat(d[a.idd]),
                e = isNaN(e) ? -99999999999999 : e,
                h = parseFloat(d[b.idd]),
            ...
            var e = Date.parse(d[a.idd]) || Date.parse("01/01/1900"),
                h = Date.parse(d[b.idd]) || Date.parse("01/01/1900");
            return c == "asc" ? e - h : h - e
        })
    },
        ...
        if (b) {
            ...
            if (this._srnd) {
                for (e = 0; e < this._fillers.length; e++) {
                    ...
                    j && this._update_fillers(e, j[1] >= d ? -1 : 0, j[0] >= d ? -1 : 0)
                }
    ...
    _addRow: function(a, b, c) {
        ...
        if (this.pagingOn) return this.rowsBuffer._dhx_insertAt(c, d),
            this.rowsAr[d.idd] = d;
        if (this._fillers) {
            ...
            for (var j = !1, i = 0; i < this._fillers.length; i++) {
                ...
                if (f && f[0] <= c && f[0] + f[1] >= c) {
                    f[1] += 1;
                    var g = f[2].firstChild.style.height = parseInt(f[2].firstChild.style.height) + this._srdh + "px",
                        j = !0;
                    if (this._fake) this._fake._fillers[i][1] ++, this._fake._fillers[i][2].firstChild.style.height = g
                }
                f && f[0] > c && (f[0] += 1, this._fake &&
    ...
    _insertRowAt: function(a, b, c) {
        ...
        c ||
            (b == this.obj.rows.length - 1 || !this.rowsCol[b] ? _isKHTML ? this.obj.appendChild(a) : this.obj.firstChild.appendChild(a) : this.rowsCol[b].parentNode.insertBefore(a, this.rowsCol[b]));
    ...
    dma: function(a) {
        ...
        if (a && !this._dma) this._dma =
            this.cells4, this.cells4 = this.cells5;
    ...
    setExternalTabOrder: function(a, b) {
        ...
        this.tabEnd.onkeydown = this.tabEnd.onkeypress = function(a) {
            e && e.call(this, a);
            var b = a || window.event;
            if (b.keyCode == 9 && b.shiftKey) return b.cancelBubble = !0, c.selectCell(c.getRowsNum() - 1, c.getColumnCount() - 1, 0, 0, 1), c.smartTabOrder && c.cells2(c.getRowsNum() -
                1, c.getColumnCount() - 1).isDisabled() && c._key_events.k9_0_1.call(c), this.blur(), !1
        };
    ...
    getStateOfView: function() {
        if (this.pagingOn) {
            ...
            return [this.currentPage, a, Math.min(a + this.rowsBufferOutSize,
