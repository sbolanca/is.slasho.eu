...
printTableHeaderJSVars('tbl_racunnapomena');
...
if (intval($SN['cnt'])>0) {
	...
	$tmpl->addVar( "opt_racun", "LOADTABLEDATA", 'tbl_racunnapomena.loadXML("ajx.php?opt=racun&act=list&pagetype='.$pagetype.'");');

}	else $tmpl->addVar( "opt_racun", "XLSHIDE", 'style="display:none"');

$mainFrame->openNavigation='racunnapomena';
