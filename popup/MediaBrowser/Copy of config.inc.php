...
include_once(substr($basePath,0,strlen($basePath)-18)."/configuration.php");
$BASE_DIR = $simConfig_absolute_media_path;

$BASE_URL = $simConfig_media_url_root;
...
$EXTS['audio']=array('mp3','Mp3','MP3');

$allowedExt=$EXTS[$mediaType];
